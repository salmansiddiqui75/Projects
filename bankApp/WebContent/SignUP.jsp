...
<tr><td class='logintd'>Enter userID:</td><td><input type="text" name='uid' class='tb' required></td></tr>
...
<tr><td class='logintd'>Enter Amount:</td><td class='logintd'><input type="text" name='amount' class='tb' required></td></tr>
